...
function prepareStatements(db) {
  let stmts = {
    ...
    latestPostsBefore: "select Post.ID, Post.Title, Post.Owner, Post.CreationTime, Post.NumComments, User.Name from Post inner join User on Post.Owner = User.Id where Post.CreationTime < ? order by Post.CreationTime desc",
    latestCommentsBefore: "select * from Comment where CreationTime < ? order by CreationTime desc",
    latestPostsByUserBefore: "select ID, Title, CreationTime, NumComments from Post where CreationTime < ? and Owner = ? order by CreationTime desc",
